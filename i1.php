...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeIn">
        ...
        <figcaption>
            ...
            <p>Si vous n'avez pas de véhicule, le covoiturage vous permet de vous déplacer moins cher avec des gens sympas !<br>
            <a href="panier.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
...
<p>Économique, le covoiturage vous permet de proposer des places et de partager les frais, avec eux.<br>
            <a href="shop1.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
...
<h2 class="text-center wowload fadeInUp">Twasalni où vous trouvez un moyen pour aller à votre université.</h2>  
  <div class="row">
