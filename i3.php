...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeIn">
        ...
        <figcaption>
            <h2>Besoin d'un cour?</h2>
            <p>Si vous n'avez pas du support du cour, Dakharny vous permet de trouver des cour bien élaborés !<br>
            <a href="i31.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
...
<img src="images/4174_l.jpg" alt="img01"/>        <figcaption>
            <h2>VOUS AVEZ UN Cour?</h2>
<p>Ici , si si vous avez un cour c'est l'emplacement on vous pouvez l'importer.<br>
            <a href="i32.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
...
<h2 class="text-center wowload fadeInUp">Dakherny permet les étudiants de trouver des supports du cours bien élaborés.</h2>  
  <div class="row">
