...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeIn">
        ...
        <figcaption>
            <h2>Wassalny</h2>
            <p>Vous avez un probléme de transport , ici vous trouvez la meilleur solution. <br>
            <a href="i1.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
<img src="images/4174_l.jpg" alt="img01"/>        <figcaption>
            <h2>Sakany</h2>
<p>Vous besoin d'un logement ou d'un coloque, on peux vous aider.<br>
            <a href="i2.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Rivezli</h2>
            <p>Vous oubliez souvant, avec Dhakerny vous vous rappellez de tous.<br>
            <a href="i3.php" title="1" data-gallery>Voir plus</a></p>            
        </figcaption>
    </figure>
    </div>
    </br>
<div id="about"  class="container spacer about">
<h2 class="text-center wowload fadeInUp">Mana3ni est le site qui permet les étudiants de résoudre leur problémes quotidiens.</h2>  
  <div class="row">
