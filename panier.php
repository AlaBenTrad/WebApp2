...
<section id="advertisement">
		<div class="container">
			<h2 class="text-center wowload fadeInUp">Twasalni ?!</h2> 
<h3 class="text-center  wowload fadeInUp">Twasalni où vous trouvez un moyen pour aller à votre université.</h3>
		</div>
	</section>
...
<option  value="Ariana">Ariana</option>
                           ...
                           </br>   <h4>Ville arrivé</h4>
				 
								<select name="ville_ar" size="0"  >
<option value="" selected >Choisissez</option>
<option value="Tunis">Tunis</option>
<option value="La Manouba">La Manouba</option>
<option value="Ben Arous">Ben Arous</option>
...
if(isset($_POST['ok'])){
	$dep =$_POST['ville_dep'];
	$ar =$_POST['ville_ar'];
$reponse = $bdd->query("SELECT * FROM wassalni where ville_dep='$dep' and ville_ar='$ar' ");
?>
...
?>
						<tr class="cart_menu">
							...
							<td class="Nombre de place">Nombre de place</td>
							<td class="Nombre de place">Date de départ</td>
							<td></td>
						</tr>
					</thead>
					<tbody>
                        ...
                        <td class="cart_product">
							...
							<td class="cart_description">
								<h4><?php
	  echo $donnees['prix']; ?></h4>
								
							</td>
							<td class="cart_price">
								<p><?php
	  echo $donnees['marque']; ?></p>
							</td>
							
							<td class="cart_total">
								<p class="cart_total_price"><?php
	  echo $donnees['nb_place']; ?></p>
							</td>
							<td class="cart_price">
								<p><?php
	  echo $donnees['date_dep']; ?></p>
							</td>
						</tr>
 <?php }} ?>
						</form>
